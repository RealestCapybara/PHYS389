...
if __name__ == '__main__':
    p1 = Pendulum(length=10, pos=[np.pi/6, 0], vel=[0,0], mass=1, zPolar=True)
    p2 = Pendulum(length=10, pos=[0.8, 0.1], vel=[0,0], mass=1)
    p3 = Pendulum(length=10, pos=[np.pi, 0.1], vel=[0,0], mass=1)
    Chain1 = Chain(pList=[p1, p2], g=9.81)
    x1 = []
    y1 = []
    z1 = []
    x2 = []
    ...
    t = np.arange(0, 8000*0.1**2, 0.1**2)
